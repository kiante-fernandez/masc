...
1. **Choice Consistency**: More consistent choices when value differences are large
```r
...
2. **Search Efficiency**: Attention allocation follows attribute importance
```r
...
3. **Attraction Search Effect**: Tendency to keep sampling from promising options
```r
